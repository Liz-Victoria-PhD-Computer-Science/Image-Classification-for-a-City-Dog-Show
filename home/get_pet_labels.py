...
def get_pet_labels(image_dir):
    ...
    # create a new list called pet_labels!
    pet_labels = []
    for pet_label in filenames:
        # Skips file if it starts with . (this is not a pet image file)
        if pet_label.startswith('.') != True:
    ...
    ## for testing
    #print("testing my pet_labels list", pet_labels)
